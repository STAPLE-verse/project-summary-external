...
<div class ="card">
  ...
  <p>This page shows the metadata collected via forms within tasks. Use the dropdown to
            select a task and view the latest submitted form for each assignee, with all form fields
            displayed as columns. You can search across columns or export the table to CSV or Excel.</p>
